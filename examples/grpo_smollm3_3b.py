"""GRPO on johnolafenwa/reasoning-rl with HuggingFaceTB/SmolLM3-3B.

This example uses the strongest prompt/setup observed locally for the model:
...
The reward is shaped to reinforce:
  ...
  - a boxed answer only when it appears after </think>,
  - correctness of that boxed answer.
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run GRPO on reasoning-rl with HuggingFaceTB/SmolLM3-3B and "
            "a very-short-thinking boxed-answer prompt."
        )
    )
    ...
    parser.add_argument("--output-dir", type=str, default="./outputs/smollm3_3b_reasoning_grpo")
