"""GRPO on johnolafenwa/reasoning-rl with Qwen/Qwen3-8B.

This example uses the strongest local inference setup observed for the base
model:
  - Qwen/Qwen3-8B in thinking mode
  - Temperature=0.6, TopP=0.95, TopK=20, MinP=0.0
  - Prompt instruction:
      "Please reason step by step, keep your reasoning under 100 words,
       and put your final answer within \\boxed{}."

The reward is shaped to reinforce:
  - a non-empty leading <think>...</think> block,
  - a boxed answer,
  - correctness of the boxed answer.
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run GRPO on reasoning-rl with Qwen/Qwen3-8B and a short-reasoning boxed-answer prompt."
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default=MODEL_ID,
        help="Tokenizer to use for vLLM rollouts.",
    )
    parser.add_argument("--output-dir", type=str, default="./outputs/qwen3_8b_reasoning_grpo")
